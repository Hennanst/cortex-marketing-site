...
# already present in the repository; do not introduce new merchant claims here.
...
# G8 build assertions: weak routes must now be visibly image-led and contain
# clear decision-path CTAs without fabricating new product destinations.
